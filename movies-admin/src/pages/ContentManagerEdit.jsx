...
const ContentManagerEdit = () => {
  ...
  const fetchContentManagerData = async () => {
    try {
      const response = await contentManagerApi.getContentManagerById(id);
      setFormData({
        name: response.name || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await contentManagerApi.updateContentManager(id, formData);
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 gap-6">
            <div>
              ...
              <input
                ...
                placeholder="Enter content manager name"
          ...
          <div className="flex justify-end space-x-4">
            <button
              type="button"
              onClick={() => navigate('/contentManagers')}
