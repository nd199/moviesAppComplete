...
const EmailVerifyUser = ({onEmailUpdate, onEmailVerified}) => {
    ...
    const otpValidationHandler = async () => {
        ...
        try {
            ...
            setShowSuccessErrorMessage(`${error?.response?.data}. Please enter your email again to re-verify.`);
            setPlaceHolder("Cena@gmail.com");
            setEmail("");
            setMailOTP("");
            setShowEmailOtp("");
                                    ...
                                    {isSendingEmail ? (
                                        ...
                                        <div className="otp-actions-user-">
                                            <button
                                                ...
                                                title={!isValidOtp(mailOtp) ? "Please enter a valid OTP" : "Click to verify your OTP"}
                                            >
                                                <Send className="send-icon-user-"/>
                                            </button>
                                            <span>
                                                OTP Expires in <span className="timer-user-">{otpTimer}</span> seconds
                                            </span>
                                        </div>
                                    )}
                                </div>
