...
const ContentManagerLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-surface-950 flex relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-teal-600 to-accent-600 relative items-center justify-center p-12">
        ...
        <div className="relative z-10 max-w-md text-white">
          ...
          <div className="mt-10 flex items-center gap-6">
            <div className="text-center"><p className="text-2xl font-bold">567</p><p className="text-sm text-white/60">Movies</p></div>
            <div className="w-px h-10 bg-white/20" />
            <div className="text-center"><p className="text-2xl font-bold">234</p><p className="text-sm text-white/60">Shows</p></div>
            <div className="w-px h-10 bg-white/20" />
            <div className="text-center"><p className="text-2xl font-bold">4K</p><p className="text-sm text-white/60">Quality</p></div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-white">Content Manager Login</h2>
            <p className="text-surface-500 mt-1">Sign in to manage your content</p>
          </div>
          ...
          <form onSubmit={loginHandler} className="space-y-5">
            <div>
              <label className="block text-sm font-semibold text-surface-500 mb-2">Email</label>
              <div className="relative">
                ...
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                  className="w-full pl-11 pr-4 py-3 bg-surface-800 border border-surface-700 rounded-xl text-white placeholder-surface-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all text-sm"
            ...
            <button type="submit" disabled={loading}
              className="w-full py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-semibold rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 text-sm">
              {loading ? (
          ...
          <div className="mt-8 pt-6 border-t border-surface-700 text-center space-y-3">
            <Link to="/admin/login" className="block text-sm text-surface-500 hover:text-brand-400 transition-colors font-medium">
              Admin Login
            </Link>
