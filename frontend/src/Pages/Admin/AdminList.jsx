    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="md:hidden space-y-3">
        {loading ? (
          ...
          admins.map((admin, idx) => (
            <div key={admin.id} className="bg-surface-900 border border-surface-700 rounded-2xl p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-surface-500 truncate">{admin.email}</div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div><span className="text-surface-500">Created:</span> <span className="text-white ml-1">{admin.createdAt ? new Date(admin.createdAt).toLocaleDateString() : '—'}</span></div>
                <div><span className="text-surface-500">Last Login:</span> <span className="text-white ml-1">{admin.lastLogin ? new Date(admin.lastLogin).toLocaleDateString() : 'Never'}</span></div>
              </div>
            </div>
          ))
        )}
