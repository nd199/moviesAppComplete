import { Facebook, Instagram, MailOutlined, PlaceOutlined, Twitter, WhatsApp } from '@mui/icons-material';
...
const Footer = () => (
  <footer className="relative bg-surface-900 text-white pt-16 pb-8 px-6 max-md:px-4 max-md:pt-10 max-md:pb-6">
