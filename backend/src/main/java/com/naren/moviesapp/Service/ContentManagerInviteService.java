...
public class ContentManagerInviteService {
    ...
    public ContentManagerInviteService(JwtUtil jwtUtil, RedisTemplate<String, String> redisTemplate) {
    ...
    public boolean validateInviteToken(String token) {
        String email = redisTemplate.opsForValue().get("cm_invite:" + token);
        return email != null;
    }
