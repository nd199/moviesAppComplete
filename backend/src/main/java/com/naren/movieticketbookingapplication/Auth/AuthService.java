...
public class AuthService {
    ...
    public AuthResponse login(AuthRequest authRequest) {
        ...
        try {
            ...
            throw new UserNotFoundException("User not found: " + usernameNotFoundException.getMessage());
        } catch (BadCredentialsException badCredentialsException) {
            throw new IncorrectPasswordException("Incorrect password " + badCredentialsException.getMessage());
        }
    }
}
