...
ALTER TABLE movie ADD COLUMN IF NOT EXISTS category VARCHAR(255) DEFAULT 'General';

-- Add category column to show table
ALTER TABLE show ADD COLUMN IF NOT EXISTS category VARCHAR(255) DEFAULT 'General';
